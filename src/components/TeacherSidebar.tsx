...
const navItems = [
  ...
  { title: "Marks / Exams", url: "/teacher/marks", icon: ClipboardList },
  { title: "Student Search", url: "/teacher/students", icon: Search },
  { title: "Training & Placement", url: "/teacher/placement", icon: Briefcase },
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4">
          <p className="mb-3 px-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">Navigation</p>
        ...
        <div className="border-t border-sidebar-border p-3">
          ...
          <div className="mt-3 rounded-lg bg-muted px-3 py-2.5">
            ...
            <p className="text-xs text-muted-foreground">{user?.branch ?? ""} Faculty</p>
          </div>
        </div>
      </aside>
    </>
